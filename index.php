...
<body>
    ...
    <div class="movie-slider-container">
            ...
            <?php foreach ($movies as $movie): ?>
                <div class="movie-card">
                    <a href="movie_info.php?id=<?= $movie['id']; ?>">
                        <img src="movie img/<?= htmlspecialchars($movie['movie_img']); ?>" alt="<?= htmlspecialchars($movie['movie_name']); ?>" />
                    </a>
        ...
        <!-- Add more movie cards if needed -->
        <!-- </div> -->
    ...
    <div class="premiere-movies">
        <div class="pmovie-container">
            <div class="pmovie-card">
                <img src="movie img/rrr.jpg" alt="Movie 1" />
                <p>Movie Title 1</p>
            </div>
            <div class="pmovie-card">
                <img src="movie img/rrr.jpg" alt="Movie 2" />
                <p>Movie Title 2</p>
            </div>
            <div class="pmovie-card">
                <img src="movie img/rrr.jpg" alt="Movie 3" />
                <p>Movie Title 3</p>
            </div>
            <div class="pmovie-card">
                <img src="movie img/rrr.jpg" alt="Movie 4" />
                <p>Movie Title 4</p>
            </div>
            <div class="pmovie-card">
                <img src="movie img/rrr.jpg" alt="Movie 5" />
                <p>Movie Title 5</p>
            </div>
        </div>
    </div>
